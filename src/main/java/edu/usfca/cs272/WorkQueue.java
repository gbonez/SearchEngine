...
public class WorkQueue {
	...
	/** Integer used to track number of tasks pending */
	private int pendingTasks;

	/** Object used exclusively for some synchronization */
		...
		public void run() {
			...
			try {
				while (true) {
					...
					// Check if shutdown has been called after executing the task
					if (shutdown) {
						break;
					}
				}
